...
export class Tree extends Layouts {
  ...
  // this.svg = new SvgStyling(configurationData, this.nodes, this.links, this.drag, this.dragcontainer, this.zoomed);
...
//     let root;
//     let treeData;
//     let width = configurationData.width - margin.right - margin.left;
//     let height = configurationData.height - margin.top - margin.bottom;
...
//     let drawTree = () => {
//       console.log(this.dataLoaderService.findRoot);
//       let rootNode = this.dataLoaderService.findRoot(this.nodes, this.links)
