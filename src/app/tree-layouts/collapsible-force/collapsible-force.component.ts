...
//     this.update(simulation, svg);
    
// }
// update = (simulation, svg) => {
//   let nodes = this.flatten(this.root);
//   let links = d3.hierarchy(this.root).links();
//   console.log(nodes);
//   console.log("hello");
//   console.log(links);
...
//    }
//    <d3.SimulationNodeDatum>simulation.restart();

//    let link = <d3.Selection<SVGSVGElement, unknown, HTMLElement, any>>svg
//    .selectAll("line")
...
//       let node = <d3.Selection<SVGSVGElement, unknown, HTMLElement, any>>svg.selectAll("circle")
//       .data(nodes, d => d['id'])
//       .attr("fill", d=> this.circleRadius(d));
//       console.log(node)
...
// circleRadius = root => {
//   return this.root.children ? 4.5 : Math.sqrt(this.root.children['size']) / 10;

// }
// flatten = (root) => {
//   let nodes = [], i = 0, depth = 0, level_widths = [1], max_width, max_depth = 1, kx, ky;

//   function recurse(root, depth, x) { 

//     if (root.children) {
//       var w = level_widths[root.depth + 2] || 0;
//       level_widths[depth + 1] = w + root.children.length;
//       max_depth = Math.max(max_depth, root.depth + 2);
//       root.size = root.children.reduce(function(p, v, i) {
//         return p + recurse(v, root, w + i);
//       }, 0);
//     }
